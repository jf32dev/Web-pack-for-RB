...
function mapStateToProps(state) {
  ...
  return {
    ...
    rebaselineLastRun: gamification.rebaselineLastRunUser,
    ...
    isResetLoading: gamification.isUserResetScoreLoading,
...
export default class AdminSocialAlgorithm extends Component {
  static contextTypes = {
  ...
  render() {
    ...
    if (!this.props.userScore || !this.props.userScore.length) {
      return (
        <Blankslate
          icon="content"
    ...
    return (
      <div className={className} style={style}>
        <AdminScoreSelector
          header={strings.userScore}
          minValue={0}
          maxValue={1}
          step={0.1}
          list={this.props.userScore}
